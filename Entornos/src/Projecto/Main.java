...
/**
 * La clase Main es el punto de entrada del programa. Crea instancias de usuarios y mensajes,
 * y muestra los mensajes visibles para cada usuario.
 */
public class Main {
    ...
    public static void main(String[] args) {
        ...
        sda.add(usuario2);
        sda.add(usuario1);
        sdad.add("De: " + mensajeMultimedia2.getRemitente().getNombre() + ", Contenido: " + mensajeMultimedia2.getContenido());
        sdad.add("De: " + mensajeMultimedia1.getRemitente().getNombre() + ", Contenido: " + mensajeMultimedia1.getContenido());
